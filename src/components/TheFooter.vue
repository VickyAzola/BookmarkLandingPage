    ...
    <div class="bg-VeryDarkBlue lg:px-28 xl:px-32">
        <nav 
            ...
            <div class="lg:flex lg:items-center lg:gap-x-16">
                ...
                <ul class="text-white uppercase mt-6 lg:flex lg:gap-x-6">
                    <li class="mb-4"
                        v-for="link in NavLinks" 
                    >
                        <a :href="link.link" class="tracking-widest hover:text-PrimarySoftRed"> {{ link.name }} </a>
                    </li>
                </ul>
            </div>

            <div class="mt-6 flex justify-center items-center gap-x-8">
        ...
        <TheCredits 
            linkFrontendMentor="https://www.frontendmentor.io/challenges/bookmark-landing-page-5d0b588a9edda32581d29158" 
            linkGithub="https://github.com/VickyAzola/BookmarkLandingPage"
        />
    </div>
</template>
